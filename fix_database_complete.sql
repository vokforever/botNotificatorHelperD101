-- Полное исправление структуры таблицы digital_notificator_services
-- Выполните этот скрипт в Supabase Dashboard -> SQL Editor
-- Этот скрипт добавляет все недостающие колонки и исправляет структуру таблицы
...
-- Проверяем структуру таблицы после исправления
SELECT column_name, data_type, is_nullable, column_default
FROM information_schema.columns 
WHERE table_name = 'digital_notificator_services'
ORDER BY ordinal_position;

-- Показываем текущие данные в таблице (если есть)
SELECT COUNT(*) as total_records FROM digital_notificator_services;
