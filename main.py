                ...
                "messages": [
                    {
                        ...
                        "content": [
                            {
                                "type": "text",
                                "text": "Распознай текст на этом изображении и верни только распознанный текст без комментариев. Если видишь информацию о сервисе, подписке, дате окончания или стоимости - обязательно укажи это. Особое внимание удели суммам, ценам и тарифам."
                            },
                            {
                                "type": "image_url",
                                "image_url": {
...
async def calculate_new_cost_with_ai(current_cost: float, change_description: str, service_name: str) -> dict:
    ...
    try:
        ...
        system_prompt = """Ты - помощник для расчета стоимости сервисов. 
